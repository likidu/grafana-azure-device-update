...
# Using the Azure CLI:
# az iot hub device-identity connection-string show --device-id MyDevKit --hub-name {YourIoTHubName} --output table
# CONNECTION_STRING = os.getenv("IOTHUB_DEVICE_CONNECTION_STRING")

# CONNECTION_STRING = 'HostName=pomelo-iot.azure-devices.net;DeviceId=TestDevice;SharedAccessKey=PQ34b7qLnxX6fh6QLtsHL4dAfXTlFSP3EXuyKZlhSUw='

# CONNECTION_STRING = 'HostName=pomelo-iot.azure-devices.net;DeviceId=AnotherTestDevice;SharedAccessKey=l/WIJ5l2FuL10HHGphgLPyDMW+DWyVQWKk79bkRSD3U='
...
@click.command()
@click.option("--device", help="You IoT Hub Device Connection String.")
def main(device):
